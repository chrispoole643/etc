...
#+BEGIN_SRC emacs-lisp
  (use-package neotree
    ...
    (defun cjp-select-neotree-window-or-toggle ()
      (interactive)
...
#+BEGIN_SRC emacs-lisp
  (global-set-key (kbd "<f1>") 'cjp-select-neotree-window-or-toggle)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "<M-f2>") 'make-frame)
  (global-set-key (kbd "<M-S-f2>") 'delete-frame)
#+END_SRC
